...
echo '2'
flex 1505015_LexAnalyzer.l		#creates the lexical analyzer or scanner named lex.yy.c
...
echo '4'
g++ -o parser.out y.o l.o -lfl -ly	#compiles the scanner and parser to create output file a.out; -lfl and -ly includes library files 					for lex and yacc(bison)

echo '5'
./parser.out 1505015_input.c		# you will need to provide proper input files with ./a.out command as instructed in assignment specification
